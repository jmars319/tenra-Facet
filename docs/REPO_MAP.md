...
- `apps/webapp`: Active Next.js shell for the early Facet product surface.
...
- `packages/domain`: Core Facet concepts like search queries, results, provenance, reframing prompts, and safety disposition.
